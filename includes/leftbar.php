<div class="left-sidebar bg-black-300 box-shadow ">
                        <div class="sidebar-content">
                            <div class="user-info closed">
                                <img src="http://placehold.it/90/c2c2c2?text=HUMG" alt="John Doe" class="img-circle profile-img">
                                <h6 class="title">Quản trị viên</h6>
                                <small class="info">HUMG</small>
                            </div>
                            <!-- /.user-info -->
                            ...
                            <div class="sidebar-nav">
                                <ul class="side-nav color-gray">
                                    ...
                                    <li>
                                        <a href="dashboard.php"><i class="fa fa-dashboard"></i> <span>Bảng điều khiển</span> </a>
